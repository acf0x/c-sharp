...
namespace WebApi1.Middleware
{
    public class Autorizacion
    {
        ...
        private readonly IConfiguration _configuration; // IConfiguration va al appsettings.json
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            try
            {
                ...
                // httpContext.Request.Headers.TryGetValue("APIKey", out var apikey); forma de simplificar las 2 lineas de arriba
